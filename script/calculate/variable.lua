...
-- Массив призов за контракт --
KonPrize = {}
--Убийство 200 Ящеров дурачков.
KonPrize[1] = {1, 62, 5003}
--Убийство 100 кенгурух.
KonPrize[2] = {2, 1037, 5004}
--Убийство 150 бандитов.
KonPrize[3] = {3, 226, 5005}
----- Страж Новичков -----
--Убить любых мобов
KonPrize[4] = {4, 3000, 5303}
--Убить любых мобов
KonPrize[5] = {5, 294, 1128}
--Убить любых мобов
KonPrize[6] = {6, 294, 1}
--------------------------

-- Массив для быстрого форжа --

-- Массив для форжа --
ScrollGems = {}
ScrollGems.Money = 2000000
-- ID свитка форжа, ID ItemInfo, ID StoneInfo --
ScrollGems[1] = {5202, 860, 9} 		-- Ловкость +7
ScrollGems[2] = {5203, 861, 10} 	-- Точность +7
ScrollGems[3] = {5204, 862, 11} 	-- Телосложение +7
ScrollGems[4] = {5205, 863, 12} 	-- Сила +7
ScrollGems[5] = {5206, 1012, 16}	-- Дух +7
ScrollGems[6] = {5207, 5849, 29}	-- Ловкость +14
ScrollGems[7] = {5208, 5848, 28}	-- Точность +14
ScrollGems[8] = {5209, 5846, 26}	-- Телосложение +14
ScrollGems[9] = {5210, 5845, 25}	-- Сила +14
ScrollGems[10] = {5211, 5847, 27}	-- Дух +14
ScrollGems[11] = {5212, 7619, 54}	-- Ловкость +20
ScrollGems[12] = {5213, 7617, 52}	-- Точность +20
ScrollGems[13] = {5214, 7618, 53}	-- Телосложение +20
ScrollGems[14] = {5215, 7615, 50}	-- Сила +20
ScrollGems[15] = {5216, 7616, 51}	-- Дух +20
ScrollGems[16] = {5217, 7929, 64}	-- Ловкость +30
ScrollGems[17] = {5218, 7927, 62}	-- Точность +30
ScrollGems[18] = {5219, 7928, 63}	-- Телосложение +30
ScrollGems[19] = {5220, 7925, 60}	-- Сила +30
ScrollGems[20] = {5221, 7926, 61}	-- Дух +30
ScrollGems[21] = {5222, 7824, 59}	-- Ловкость +40
ScrollGems[22] = {5223, 7822, 57}	-- Точность +40
ScrollGems[23] = {5224, 7823, 58}	-- Телосложение +40
ScrollGems[24] = {5225, 7820, 55}	-- Сила +40
ScrollGems[25] = {5226, 7821, 51}	-- Дух +40

-- Массив для улучшения вещей --
Upgrade = {}
...
TeamExp_RAID = 1			--Team Experience Rate (TeamExp_Increas = 0.25 * TeamExp_RAID) ( default = 1 )
ELEEXP_GETRAD = 1000		--Pet Growth Rate ( default = 1 )
LV_LIMIT = 50				--?????????
A_B_C = 8					--??????
Money_all = 50000000		--????????????
How_Many_Active = 0			--????????????
...
ChangeItemList[	13	]=	{	7461	,	2	,	4283	,	1	}
ChangeItemList[	14	]=	{	7461	,	2	,	4275	,	1	}
ChangeItemList[	15	]=	{	7461	,	2	,	4276	,	1	}
ChangeItemList[	16	]=	{	7461	,	2	,	4277	,	1	}
ChangeItemList[	17	]=	{	7461	,	2	,	4278	,	1	}
ChangeItemList[	18	]=	{	7461	,	2	,	4279	,	1	}
ChangeItemList[	19	]=	{	7461	,	2	,	4280	,	1	}
ChangeItemList[	20	]=	{	7461	,	1	,	4281	,	1	}
ChangeItemList[	21	]=	{	7461	,	1	,	4282	,	1	}
ChangeItemList[	22	]=	{	7459	,	1	,	2842	,	1	}
ChangeItemList[	23	]=	{	3457	,	500	,	7487	,	1	}
ChangeItemList[	24	]=	{	3457	,	1000	,	2843	,	1	}--
ChangeItemList[	25	]=	{	7461	,	1	,	7488	,	1	}
ChangeItemList[	26	]=	{	7461	,	1	,	7531	,	1	}
ChangeItemList[	27	]=	{	7498	,	1	,	7497	,	1	}
ChangeItemList[	28	]=	{	7499	,	1	,	7500	,	1	}
...
ChangeItemList[ 249	]=	{	7416	,	1	,	7355	,	1	}
ChangeItemList[ 250	]=	{	7417	,	9	,	7320	,	1	}
ChangeItemList[ 251	]=	{	7417	,	9	,	7321	,	1	}
ChangeItemList[ 252	]=	{	7417	,	9	,	7322	,	1	}
ChangeItemList[ 253	]=	{	7417	,	9	,	7323	,	1	}
ChangeItemList[ 254	]=	{	7417	,	9	,	7324	,	1	}
ChangeItemList[ 255	]=	{	7417	,	9	,	7325	,	1	}
ChangeItemList[ 256	]=	{	7417	,	15	,	192	,	1	    }
ChangeItemList[ 257	]=	{	7417	,	8	,	7336	,	1	}
...
Item_CanJinglian_ID [14] = 		27	-- Cloak

--????????

StoneAttrType_Num = 64 --????? ?????
--??? ???? ?????
StoneAttrType = {}
StoneAttrType [0]		=		0
...
StoneAttrType [50]		=		ITEMATTR_VAL_STR	--???????? ???
StoneAttrType [51]		=		ITEMATTR_VAL_STA	--???????? ??
StoneAttrType [52]		=		ITEMATTR_VAL_DEX	--???????? ???
StoneAttrType [53]		=		ITEMATTR_VAL_CON	--???????? ????
StoneAttrType [54]		=		ITEMATTR_VAL_AGI	--???????? ???
StoneAttrType [55]		=		ITEMATTR_VAL_STR	--???????? ???
StoneAttrType [56]		=		ITEMATTR_VAL_STA	--???????? ??
StoneAttrType [57]		=		ITEMATTR_VAL_DEX	--???????? ???
StoneAttrType [58]		=		ITEMATTR_VAL_CON	--???????? ????
StoneAttrType [59]		=		ITEMATTR_VAL_AGI	--???????? ???
StoneAttrType [60]		=		ITEMATTR_VAL_STR	--???????? ???
StoneAttrType [61]		=		ITEMATTR_VAL_STA	--???????? ??
StoneAttrType [62]		=		ITEMATTR_VAL_DEX	--???????? ???
StoneAttrType [63]		=		ITEMATTR_VAL_CON	--???????? ????
StoneAttrType [64]		=		ITEMATTR_VAL_AGI	--???????? ???
...
STAR_ATTR[12]				=	"Max HP modulus bonus"				--??Hp????         
STAR_ATTR[13]				=	"Max SP modulus bonus"				--??Sp????         
...
STAR_ATTR[37]				=	"Max HP constant bonus"				--??Hp????         
STAR_ATTR[38]				=	"Max SP constant bonus"				--??Sp????         
...
STAR_ATTR[43]				=	"HP Recovery Rate constant bonus"		--hp????????   
STAR_ATTR[44]				=	"SP Recovery Rate constant bonus"		--sp????????    
...
-------------------------
	...
	LHJ_ID	[	66	]	=	7497 --сеты
	LHJ_ID	[	67	]	=	7500 --сеты
	LHJ_ID	[	68	]	=	7319--крылоповелителя
	LHJ_ID	[	69	]	=	790
	LHJ_ID	[	70	]	=	791
	LHJ_ID	[	71	]	=	792
	LHJ_ID	[	72	]	=	793
...
StoneEff = {}
StoneEff [0]			=		0
StoneEff [1]			=		150	--Огненный самоцвет
StoneEff [2]			=		160 	--Самоцвет Ярости
StoneEff [3]			=		180	--Взрывной самоцвет
StoneEff [4]			=		20	--Люстриновый самоцвет
StoneEff [5]			=		90	--Сияющий самоцвет 
StoneEff [6]			=		10000	--Блестящий самоцвет
StoneEff [7]			=		20	--Теневой самоцвет 
StoneEff [8]			=		5	--Самоцвет Духа
StoneEff [9]			=		7	--Самоцвет Ветра
StoneEff [10]			=		7	--Самоцвет удара
StoneEff [11]			=		7	--Самоцвет колосса 
StoneEff [12]			=		7	--Самоцвет Ярости
StoneEff [13]			=		200	--Глаз черного дракона
StoneEff [14]			=		3	--Душа Черного дракона
StoneEff [15]			=		5000	--Сердце черного дракона
StoneEff [16]			=		7	--Самоцвет души
StoneEff [17]			=		1000	--Желтый нефрит
StoneEff [18]			=		5000	--Красный нефрит
StoneEff [19]			=		5000	--Зеленый нефрит
StoneEff [20]			=		10	--Аура Чиатана
StoneEff [21]			=		50	--Удар Лока
StoneEff [22]			=		50	--Уклонение Бинга
StoneEff [23]			=		300	--Защита Фенга
StoneEff [24]			=		30000	--Усиление Акулы
StoneEff [25]			=		10	--Сияние Азраила
StoneEff [26]			=		10	--Неупокоенный Азраил
StoneEff [27]			=		10	--Свет Азраила
StoneEff [28]			=		10	--Соединение Азраила
StoneEff [29]			=		10	--Танец Азраила
StoneEff [30]			=		20	--Сломанный Самоцвет Ветра
StoneEff [31]			=		25	--Треснутый Самоцвет Ветра
StoneEff [32]			=		4	--Неограненный Самоцвет Ветра
StoneEff [33]			=		20	--Сломанный Самоцвет Удара
StoneEff [34]			=		25	--Треснутый Самоцвет Удара
StoneEff [35]			=		4	--Неограненный Самоцвет Удара
StoneEff [36]			=		20	--Сломанный Самоцвет Колосса
StoneEff [37]			=		25	--Треснутый Самоцвет Колосса
StoneEff [38]			=		4	--Неограненный Самоцвет Колосса
StoneEff [39]			=		20	--Сломанный Самоцвет Ярости
StoneEff [40]			=		25	--Треснутый Самоцвет Ярости
StoneEff [41]			=		4	--Неограненный Самоцвет Ярости
StoneEff [42]			=		20	--Сломанный Самоцвет Души
StoneEff [43]			=		25	--Треснутый Самоцвет Души
StoneEff [44]			=		4	--Неограненный Самоцвет Души
StoneEff [45]			=		14	--Великий Самоцвет Ярости
StoneEff [46]			=		14	--Великий Самоцвет Души
StoneEff [47]			=		14	--Великий Самоцвет Удара
StoneEff [48]			=		14	--Великий Самоцвет Колосса
StoneEff [49]			=		14	--Великий Самоцвет Ветра
StoneEff [50]			=		20	--Великий Самоцвет Ярости
StoneEff [51]			=		20	--Великий Самоцвет Души
StoneEff [52]			=		20	--Великий Самоцвет Удара
StoneEff [53]			=		20	--Великий Самоцвет Колосса
StoneEff [54]			=		20	--Великий Самоцвет Ветра
StoneEff [55]			=		40	--Великий Самоцвет Ярости
StoneEff [56]			=		40	--Великий Самоцвет Души
StoneEff [57]			=		40	--Великий Самоцвет Удара
StoneEff [58]			=		40	--Великий Самоцвет Колосса
StoneEff [59]			=		40	--Великий Самоцвет Ветра
StoneEff [60]			=		30	--Великий Самоцвет Ярости
StoneEff [61]			=		30	--Великий Самоцвет Души
StoneEff [62]			=		30	--Великий Самоцвет Удара
StoneEff [63]			=		30	--Великий Самоцвет Колосса
StoneEff [64]			=		30	--Великий Самоцвет Ветра
...
StoneTpye_ID [24]	=		5775	--?i?e €??
StoneTpye_ID [25]	=		5845	--??e €о??						
StoneTpye_ID [26]	=		5846	--?????? €о??
StoneTpye_ID [27]	=		5847	--?? €о??
StoneTpye_ID [28]	=		5848	--??o?e €о??
StoneTpye_ID [29]	=		5849	--???€о??
...
StoneTpye_ID [50]	=		7615	--???????? ???
StoneTpye_ID [51]	=		7616	--???????? ??
StoneTpye_ID [52]	=		7617	--???????? ???
StoneTpye_ID [53]	=		7618	--???????? ????
StoneTpye_ID [54]	=		7619	--???????? ???
StoneTpye_ID [55]	=		7820	--???????? ???
StoneTpye_ID [56]	=		7821	--???????? ??
StoneTpye_ID [57]	=		7822	--???????? ???
StoneTpye_ID [58]	=		7823	--???????? ????
StoneTpye_ID [59]	=		7824	--???????? ???
StoneTpye_ID [60]	=		7925	--???????? ???
StoneTpye_ID [61]	=		7926	--???????? ??
StoneTpye_ID [62]	=		7927	--???????? ???
StoneTpye_ID [63]	=		7928	--???????? ????
StoneTpye_ID [64]	=		7929	--???????? ???
...
StoneEffType[22] =		2	--????????
StoneEffType[23] =		2	--??? ???
StoneEffType[24] =		4	--?i?e €??
StoneEffType[25] =		4	--??e €о??
StoneEffType[26] =		4	--?????? €о??
StoneEffType[27] =		4	--?? €о??
StoneEffType[28] =		4	--??o?e €о??
StoneEffType[29] =		4	--???€о??
StoneEffType[30] =		4	--????????? ???
StoneEffType[31] =		4	--????????? ???
StoneEffType[32] =		4	--?????? ???? ???
...
StoneItemType[2] = { 2,3,7,9,0 }	--Самоцвет Ярости (к??????в двуручные мечи, луки, клинки покорителей морей, посохи)
StoneItemType[3] = { 3,4,0 }	--Взрывной самоцвет (куется в пистолеты)
...
StoneItemType[6] = { 11,22,25,26,27,0 }	--Блестящий самоцвет (куется в щиты, доспехи, тату)
...
StoneItemType[8] = { 1,2,3,4,7,9,24,25,26,0 }	--Самоцвет Духа (куется в мечи, двуручные мечи, луки, клинки покорителей морей, посохи, ботинки)
StoneItemType[9] = { 24,25,26,0 }	--Самоцвет Ветра (куется в ботинки)     
StoneItemType[10] = { 3,4,23,25,26,0 }	--Самоцвет удара (куется в перчатки)	      
StoneItemType[11] = { 11,22,27,25,26,0 }	--Самоцвет колосса (куется в щиты, доспехи, тату)
StoneItemType[12] = { 1,2,3,4,7,9,25,26,0 }	--Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
...
StoneItemType[16] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Самоцвет души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи, перчатки)
StoneItemType[17] = { 11,20,0 }	--Желтый нефрит (куется в шапки для Ами)
StoneItemType[18] = { 11,20,0 }	--Красный нефрит (куется в шапки для Ами)
...
StoneItemType[23] = { 11,22,27,0 }	--Защита Фенга (куется в доспехи и тату)
StoneItemType[24] = { 22,11,27,0 }	--Усиление Акулы (куется в доспехи, щиты и тату)
StoneItemType[25] = { 1,2,3,4,7,9,25,26,0 } --Сияние Азраила (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[26] = { 11,22,25,26,27,0 }	--Неупокоенный Азраил (куется в доспехи и тату)
StoneItemType[27] = { 1,2,3,4,7,9,22,23,24,25,26,27,0 }	--Свет Азраила (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи доспехи и тату)
StoneItemType[28] = { 1,2,3,4,7,9,23,25,26,0 }	--Соединение Азраила (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи и перчатки)
StoneItemType[29] = { 24,25,26,0 }	--Танец Азраила (куется в ботинки)
StoneItemType[30] = { 24,25,26,0 }	--Сломанный Самоцвет Ветра (куется в ботинки)    
StoneItemType[31] = { 24,25,26,0 }	--Треснутый Самоцвет Ветра (куется в ботинки)   
StoneItemType[32] = { 24,25,26,0 }	--Неограненный Самоцвет Ветра (куется в ботинки)  
StoneItemType[33] = { 3,4,23,25,26,0 }    --Сломанный Самоцвет Удара (куется в перчатки)   
StoneItemType[34] = { 3,4,23,25,26,0 }    --Треснутый Самоцвет Удара (куется в перчатки)   
StoneItemType[35] = { 3,4,23,25,26,0 }    --Неограненный Самоцвет Удара (куется в перчатки)   
StoneItemType[36] = { 11,22,25,26,27,0 }	--Сломанный Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[37] = { 11,22,26,26,27,0 }	--Треснутый Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[38] = { 11,22,25,26,27,0 }	--Неограненный Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[39] = { 1,2,3,4,7,9,25,26,0 }	--Сломанный Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[40] = { 1,2,3,4,7,9,25,26,0 }	--Треснутый Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[41] = { 1,2,3,4,7,9,25,26,0 }	--Неограненный Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[42] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Сломанный Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[43] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Треснутый Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[44] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Неограненный Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[45] = { 1,2,3,4,7,9,25,26,0 } 	--Великий Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[46] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Великий Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[47] = { 3,4,23,25,26,0 }	--Великий Самоцвет Удара (куется в перчатки)
StoneItemType[48] = { 11,22,25,26,27,0 } --Великий Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[49] = { 24,25,26,0 } --Великий Самоцвет Ветра (куется в ботинки)
StoneItemType[50] = { 1,2,3,4,7,9,25,26,0 } 	--Великий Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[51] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Великий Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[52] = { 3,4,23,25,26,0 }	--Великий Самоцвет Удара (куется в перчатки)
StoneItemType[53] = { 11,22,25,26,27,0 } --Великий Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[54] = { 24,25,26,0 } --Великий Самоцвет Ветра (куется в ботинки)
StoneItemType[55] = { 20,0 } 	--Великий Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[56] = { 20,0 }	--Великий Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[57] = { 20,0 }	--Великий Самоцвет Удара (куется в перчатки)
StoneItemType[58] = { 20,0 } --Великий Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[59] = { 20,0 } --Великий Самоцвет Ветра (куется в ботинки)
StoneItemType[60] = { 1,2,3,4,7,9,25,26,0 } 	--Великий Самоцвет Ярости (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[61] = { 1,2,3,4,7,9,23,24,25,26,0 }	--Великий Самоцвет Души (куется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
StoneItemType[62] = { 3,4,23,25,26,0 }	--Великий Самоцвет Удара (куется в перчатки)
StoneItemType[63] = { 11,22,25,26,27,0 } --Великий Самоцвет Колосса (куется в щиты, доспехи и тату)
StoneItemType[64] = { 24,25,26,0 } --Великий Самоцвет Ветра (куется в ботинки)
...
notices[1] = "\211 \237\224\241 \239\238\255\226\232\235\241\255 \244\238\240\243\236 \241 \227\224\233\228\224\236\232 www.forum.piratia-innovation.ru "
notices[2] = "\209\234\238\240\238 \238\225\237\238\226\235\229\237\232\229 \241\229\240\226\229\240\224! \209\235\229\228\232\242\229 \231\224 \237\238\226\238\241\242\255\236\232 \226 \237\224\248\229\233 \227\240\243\239\239\229 \226\234 https://vk.com/piratia.innovation ."
notices[3] = "\205\224\248\224 \225\229\241\229\228\224 \226\234\238\237\242\224\234\242\229 https://vk.me/join/AJQ1dyn2nQJmhDUP4vQmu4dj ."
