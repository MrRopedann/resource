...
function ConditionsTest( character, conditions, param1, param2, npc )
	...
	if conditions[1] == nil then
		...
		for i = 1, num, 1 do
			...
			-- 橡钼屦赅 磬 溴睃 礤溴腓 --
			elseif conditions[i].func == CheckDay then
				PRINT( "ConditionsTest:CheckDay, p1 = ", conditions[i].p1 )
				local ret = CheckDay( character, conditions[i].p1 )
				if ret ~= LUA_TRUE then
					PRINT( "ConditionsTest: CheckDay = false" )
					return LUA_FALSE
				end
...
--			Notice("做任务奖励经验的防沉迷返还系数为"..retExpState)
		...
		elseif actions[i].func == Exchange_7 then
			PRINT( "ActionProc:Exchange_7, p1 = , p2 = , p3 = , p4 = ", actions[i].p1, actions[i].p2, actions[i].p3, actions[i].p4 ) 
			Exchange_7( character, actions[i].p1, actions[i].p2, actions[i].p3, actions[i].p4 )	
		elseif actions[i].func == exchange_sue_fast then
			PRINT( "ActionProc:exchange_sue_fast, p1 = ", actions[i].p1 ) 
			exchange_sue_fast( character, actions[i].p1 )	
		elseif actions[i].func == MegaBuff then
			PRINT( "ActionProc:MegaBuff" ) 
			MegaBuff( character, npc )
		elseif actions[i].func == GetKontrakt then
			PRINT( "ActionProc:GetKontrakt, p1 = , p2 = , p3 = ", actions[i].p1, actions[i].p2, actions[i].p3 ) 
			GetKontrakt( character, actions[i].p1, actions[i].p2, actions[i].p3 )
		elseif actions[i].func == ReAll then
			PRINT( "ActionProc:ReAll" )
			ReAll( character )
		elseif actions[i].func == DeleteKontrakt then
			PRINT( "ActionProc:DeleteKontrakt" )
			DeleteKontrakt( character )
...
function AddChaItem8(character)
    local role_kj=GetChaItem2( character , 2 , 3280 )           -- Экзаменационная бумага
    ...
    if del_item==0  then
        SystemNotice (character, "\205\229 \243\228\224\235\238\241\252 \239\238\235\243\247\232\242\252 \221\234\231\224\236\229\237\224\246\232\238\237\237\243\254 \225\243\236\224\227\243")
...
function checkcytime( character , npc )
    local role_xsz = GetChaItem2 ( character , 2 , 3289 )               -- Студенческая карта
    ...
    local role_cjd = GetChaItem2 ( character , 2 , 3279 )               -- Табель успеваемости
    local cha_name = GetChaDefaultName ( character )
    local newch_xsz = ch_xsz + math.floor(50*(exp_xsz/mexp_xsz))
    if newch_xsz <= mch_xsz then
        SystemNotice (character, "\207\238\231\228\240\224\226\235\255\229\236, \194\251 \243\241\239\229\248\237\238 \241\228\224\235\232 \253\234\231\224\236\229\237!")
        ...
        SystemNotice (character, "\207\238\231\228\240\224\226\235\255\229\236, \194\251 \243\241\239\229\248\237\238 \241\228\224\235\232 \253\234\231\224\236\229\237 \232 \228\238\241\242\232\227\235\232 \236\224\234\241\232\236\224\235\252\237\238\227\238 \234\238\235\232\247\229\241\242\226\224 \238\239\251\242\224!")
    ...
    if del_item == 0 then
        SystemNotice( character, "\205\229 \243\228\224\235\238\241\252 \239\238\235\243\247\232\242\252 \210\224\225\229\235\252 \243\241\239\229\226\224\229\236\238\241\242\232")
...
function checksjtime( character ,npc )
    ...
    if del_item == 0 then
        SystemNotice( character, "\205\229 \243\228\224\235\238\241\252 \239\238\235\243\247\232\242\252 \210\224\225\229\235\252 \243\241\239\229\226\224\229\236\238\241\242\232 \239\238 \239\229\240\229\226\238\228\237\238\236\243 \253\234\231\224\236\229\237\243")
