...
function HistoryMission001()
	DefineMission( 200, "Начало Пути ", 200 )
	MisBeginTalk( "<t>Добрый день.Я думаю что тебе пора отнести письмо священнику Шайтана, <bБобу>. Удачи и не опаздывай!  " )
	...
	MisNeed(MIS_NEED_DESP, "Священник находится в Шайтане по координатам  (862,3500) ")
	MisHelpTalk("<t>Почему вы не встретились с Священником Шайтана?Пожалуйста поторопитесь ")
	MisResultCondition(AlwaysFailure )
	DefineMission( 201, "Начало Пути ", 201 )
	MisBeginTalk( "<t>Добрый день.Я думаю что тебе пора отнести письмо священнику Шайтана, <bБобу>. Удачи и не опаздывай!  " )
	MisBeginCondition(NoRecord, 200)
	MisBeginCondition(NoMission, 200)
	MisBeginCondition(NoMission, 201)
	...
	MisHelpTalk("<t>Почему вы не встретились с Священником Шайтана?Пожалуйста поторопитесь ")
	MisResultCondition(AlwaysFailure )
	DefineMission( 202, "Начало Пути ", 202 )
	MisBeginTalk( "<t>Добрый день.Я думаю что тебе пора отнести письмо священнику Шайтана, <bБобу>. Удачи и не опаздывай!  " )
	MisBeginCondition(NoRecord, 200)
	MisBeginCondition(NoMission, 200)
	MisBeginCondition(NoMission, 201)
	...
	MisHelpTalk("<t>Почему вы не встретились с Священником Шайтана?Пожалуйста поторопитесь ")
	MisResultCondition(AlwaysFailure )
	DefineMission( 203, "Начало Пути ", 200, COMPLETE_SHOW )
	...
	DefineMission( 204, "Начало Пути ", 201, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisResultAction(AddMoney,999,999)
	MisResultAction(AddExpAndType,2,875,875)
	DefineMission( 205, "Начало Пути ", 202, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Я хотел бы просить вас провести расследование некоторых странных событий в Пустыне Шайтана. <n> <t> Однако до того как дать вам это задание,я вынужден испытать вас<n> <t> Сходите в<pОкраины Шайтана>, и поговорите с Толиком. " )
	...
	MisNeed(MIS_NEED_DESP, "Найти<bТолика> в <pОкраины Шайтана> 981,3603)")
	MisHelpTalk("<t>Какие еще вопросы? Если их нету ,то пожалуйста, найдите <bТолика> он назначит вам задание.")
	MisResultCondition(AlwaysFailure )
	DefineMission( 207, "Пустяковая задача ", 203, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
		
	MisResultTalk("<t>Ах,Священик очень странный парень ,посылает нам неизвестно кого.Доверяет ли он власти? <n> <t> Возвращайся когда будешь готов.У меня есть задание для тебя ")
	...
	MisResultAction(AddExpAndType,2,875,875)
	DefineMission( 208, "Поручение Толика ", 204 )
	MisBeginTalk( "<t>Я думаю вы способны выполнить эти задания.Принесите мне некоторые предметы. <n> <t> Мне нужно 30 <yСундук Кэль 100шт>, 3 <yКарты Юного Кактуса> и 3 <yКарты Бати Кактусов >." )
	...
	MisBeginAction(AddTrigger, 2041, TE_GETITEM, 7467, 30 )		
	MisBeginAction(AddTrigger, 2042, TE_GETITEM, 7704, 3 )		
	MisBeginAction(AddTrigger, 2043, TE_GETITEM, 7703, 3 )
	MisCancelAction(ClearMission, 204)
	MisNeed(MIS_NEED_ITEM, 7467, 30, 30, 30)
	MisNeed(MIS_NEED_ITEM, 7704, 3, 20, 3)
	MisNeed(MIS_NEED_ITEM, 7703, 3, 30, 3)
	MisResultTalk("<t>Даже если вы выполнили это задание, до наших стандартов вам далеко.")
	MisHelpTalk("<t>Такая простая задача, и вы не можете справиться? <n> <t> Помните! Я требую от вас <yСундук Кэль 100шт>, 3 <yКарты Юного Кактуса> и 3 <yКарты Бати Кактусов >.")
	MisResultCondition(HasMission, 204)
	MisResultCondition(HasItem, 7467, 30 )
	MisResultCondition(HasItem, 7704, 3 )
	MisResultCondition(HasItem, 7703, 3 )
	MisResultAction(TakeItem, 7467, 30 )
	MisResultAction(TakeItem, 7704, 3 )
	MisResultAction(TakeItem, 7703, 3 )
	...
	TriggerAction( 1, AddNextFlag, 204, 10, 30 )
	RegCurTrigger( 2041 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 7704)	
	TriggerAction( 1, AddNextFlag, 204, 20, 3 )
	RegCurTrigger( 2042 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 7703)	
	TriggerAction( 1, AddNextFlag, 204, 30, 3 )
	RegCurTrigger( 2043 )
	DefineMission( 209, " Пропавший Томми ", 205 )
	MisBeginTalk( "<t>Поскольку вы  здесь, почему бы вам не помоч найти пропавшего ребенка. Его зовут <bТомми>. В последний раз его видили недалеко от <pШайтана>. Верните его домой благополучно!" )
	...
	MisNeed(MIS_NEED_DESP, "Найти Томми по координатам (931,3529)")
	MisHelpTalk("<t>Несколько людей видели <bТомми> недалеко от <pШайтана>.Поищи там ")
	MisResultCondition(AlwaysFailure )
	DefineMission( 210, "Пропавший Томми ", 205, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
		
	MisResultTalk("<t>Вы искали меня? Я пришел сюда,когда гулял.")
	...
	MisResultAction(AddExpAndType,2,875,875)
	DefineMission( 211, "Доложить Толику ", 206 )
	MisBeginTalk( "<t>Я удивлен тем, что Толик ищет меня. Я хотел бы поблагодарить его за заботу.Принеси ему это письма,в доказательство того что я в безопасости. Я собираюсь остаться здесь еще на некоторое время.." )
	...
	MisNeed(MIS_NEED_DESP, "Отнеси письмо Толик по координатам (981,3603) ")
	MisHelpTalk("<t>Что-нибудь еще?Я скоро вернусь,обещаю..")
	MisResultCondition(AlwaysFailure )
	DefineMission( 212, "Доложить Толику ", 206, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisResultAction(AddMoney,1100,1100)	
	MisResultAction(AddExpAndType,2,875,875)
	DefineMission( 213, "Новое Поручение ", 207 )
	MisBeginTalk( "<t>Вам нужно навестить Повариху Шайтана(888,3620) и передать ей образец" )
	...
	RegCurTrigger( 2071 )
	DefineMission( 214, "Проверка Еды ", 207, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisBeginTalk( "<t>Я рассмотрел еду, проблема в том что Мясо Кенгуру было заражено.Мне потребуется несколько ингредиентов для противоядия. Не могли бы Вы помочь в их поисках?" )
	...
	MisBeginAction(AddTrigger, 2081, TE_GETITEM, 7765, 3 )
	MisBeginAction(AddTrigger, 2082, TE_GETITEM, 7766, 3 )		
	MisBeginAction(AddTrigger, 2083, TE_GETITEM, 7770, 3 )		
	MisCancelAction(ClearMission, 208)
	MisNeed(MIS_NEED_ITEM, 7765, 3, 10, 3)
	MisNeed(MIS_NEED_ITEM, 7766, 3, 20, 3)
	MisNeed(MIS_NEED_ITEM, 7770, 3, 30, 3)
	MisPrize(MIS_PRIZE_ITEM, 3967, 1, 4)
	MisPrizeSelAll()
	MisResultTalk("<t>Великолепно!Пожалуйста, дай мне время для приготовления  противоядия. <n> <T> Получилось! Отнеси это Толику .")
	MisHelpTalk("<t>Ты разыскал все?")
	MisResultCondition(HasMission, 208)
	MisResultCondition(HasItem, 7765, 3 )
	MisResultCondition(HasItem, 7766, 3 )
	MisResultCondition(HasItem, 7770, 3 )
	MisResultAction(TakeItem, 7765, 3 )
	MisResultAction(TakeItem, 7766, 3 )
	MisResultAction(TakeItem, 7770, 3 )
	...
	MisResultBagNeed(1)
	InitTrigger()
	TriggerCondition( 1, IsItem, 7765)	
	TriggerAction( 1, AddNextFlag, 208, 10, 3 )
	RegCurTrigger( 2081 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 7766)	
	TriggerAction( 1, AddNextFlag, 208, 20, 3 )
	RegCurTrigger( 2082 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 7770)	
	TriggerAction( 1, AddNextFlag, 208, 30, 3 )
	RegCurTrigger( 2083 )
	DefineMission( 216, "Просьба Жорика ", 209 )
	MisBeginTalk( "<t>Недавно заходил Жорик и попросил тебе наведаться к нему по одному странному дело,он говорил что-то про мутацию монстров и превращение в главарей" )
	...
	MisNeed(MIS_NEED_DESP, "Спросите Жорика что он хотел ")
	MisHelpTalk("<t>Поговори с ним")
	MisResultCondition(AlwaysFailure )
	DefineMission( 217, "Главари?  ", 209, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	...
	MisResultAction(AddExpAndType,2,875,875)
	DefineMission( 218, "Причина Мутаций ", 210 )
	MisBeginTalk( "<t>Хорошо, после некоторых исследований, мы должны проверить кое-что,принесите мне Паутину для извлечения ДНК" )
	...
	MisBeginAction(AddTrigger, 2101, TE_GETITEM, 1728, 5 )		
	MisCancelAction(ClearMission, 210)
	MisNeed(MIS_NEED_ITEM, 1728, 5, 10, 5)
	MisResultTalk("<t>Днк Паутины поможет для выяснения причины мутации.Я проведу побольше исследований по ней, и узнаю как обстоит дело..")
	MisHelpTalk("<t>Что такое? Почему Вы до сих пор не принесли Паутину?")
	MisResultCondition(HasMission, 210)
	MisResultCondition(HasItem, 1728, 5 )
	MisResultAction(TakeItem, 1728, 5 )
	...
	MisResultAction(AddExpAndType,2,875,875)
	InitTrigger()
	TriggerCondition( 1, IsItem, 1728)	
	TriggerAction( 1, AddNextFlag, 210, 10, 5 )
	RegCurTrigger( 2101 )
	DefineMission( 219, "Тщательное исследование ", 211 )
	MisBeginTalk( "<t>После ряда исследований, есть странность в том, что Пауки питались только травой. <n> <T> Я не буду абсолютно уверен, пока вы не принесете мне Карту Паука" )
	...
	MisBeginAction(AddTrigger, 2111, TE_GETITEM, 7762, 1 )		
	MisCancelAction(ClearMission, 211)
	MisNeed(MIS_NEED_ITEM, 7762, 1, 10, 1)
	...
	MisResultCondition(HasItem, 7762, 1 )
	MisResultAction(TakeItem, 7762, 1 )
	...
	MisResultAction(AddExpAndType,2,875,875)
	InitTrigger()
	TriggerCondition( 1, IsItem, 7762)	
	TriggerAction( 1, AddNextFlag, 211, 10, 1 )
	RegCurTrigger( 2111 )
	DefineMission( 220, "Отчет Жорика ", 212 )
	MisBeginTalk( "<t>Это расследование продлится еще некоторое время, я написал предварительный <yОтчет>. <n> <T> Пожалуйста доставь его Мудрецу в Шайтан(865,3568)" )
	...
	MisNeed(MIS_NEED_DESP, "Доставь отчет Мудрецу Шайтана  (2219, 2749)")
	MisHelpTalk("<t>Что не так? ")
	MisResultCondition(AlwaysFailure )
	DefineMission( 221, "Отчет Жорика ", 212, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
		
	MisResultTalk("<tВ отчете Жорика я прочитал о ваших успехах.Я рад за Вас.")
	...
	MisBeginTalk( "<t>Говорят, что недалеко от Шахт Шайтана проблемы. Отнеси рекомендательное письмо Портальщице шахт." )
	...
	MisNeed(MIS_NEED_DESP, "Отнести письмо Портальщице Шахт (1369, 3033).")
	MisHelpTalk("<t>Иди к Шахтам(зоны) !")
	MisResultCondition(AlwaysFailure )
	DefineMission( 223, "Новое задание ", 213, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
		
	MisResultTalk("<t>Тебя прислал Мудрец? Рада познакомиться.")
	...
	MisBeginTalk( "<t>Недавно кто-то украл инструменты немогли бы вы обыскать всё вокруге и найти их??" )
	...
	RegCurTrigger( 2143 )
	DefineMission( 225, "Убить Обитателя ", 215 )
	MisBeginTalk( "<t>Мой главная задача состоит в том, чтобы избавиться от Пещерных Обитателей, но Главный Пещерный Обитатель очень мешает!(Респ 10 минут)" )
	...
	MisBeginAction(AddTrigger, 2151, TE_KILL, 1043, 10 )		
	MisCancelAction(ClearMission, 215)
	MisNeed(MIS_NEED_KILL, 1043, 10, 10, 10)
	MisResultTalk("<t>Хорошая работа! Без их главаря у них нет и шанса!")
	MisHelpTalk("<t>Будте аккуратны!")
	...
	InitTrigger()
	TriggerCondition( 1, IsMonster, 1043)	
	TriggerAction( 1, AddNextFlag, 215, 10, 10 )
	RegCurTrigger( 2151 )
	DefineMission( 226, "Просьба Дитто ", 216 )
	MisBeginTalk( "<t>Совсем скоро будет готово продолжение!" )
