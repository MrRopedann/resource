...
function get_map_entry_pos_stuja()
    return 1
end
...
function map_run_stuja( map ) 

end

function map_copy_run_stuja(map_copy)

end

function after_player_login_stuja(entry, player_name)
